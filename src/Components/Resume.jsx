...
const Resume = () => {
  ...
  return (
    <div className="page resume-container max-w-xs  mx-auto  border relative p-3" id="resume">
...
<p className="section-title">Education</p>
        ...
        <ul>
           ...
           The Assam Kaziranga University 
            ...
            <p className="text">Completed my Bachelors in Technology from the assam kaziranga University on 2023 with a CGPA - <span className="yellow">8.02</span></p>
            
           </li>
           <li>
           Jawaharlal Nehru Vidyalaya 
            <p>2017 - 2019</p>
            <p className="text">12th | Percentage - <span className="yellow">76.4%</span></p>
            
           </li>
           <li>
           {`Government High Secondary School Ganga (AR)`} 
            <p>2015 - 2017</p>
            <p className="text">10th | CGPA - <span className="yellow">10</span></p>
...
<p className="section-title">Skills</p>
        ...
        <ul className="pl-8 skill-list flex flex-wrap gap-2">
           ...
           <p className="bar">
             <span className="progress-bar dsa"></span>
           </p>
           </li>
           <li>
           ML & AI
           <p className="bar">
             <span className="progress-bar ml"></span>
           </p>
           </li>
           <li>Java Programming
           <p className="bar">
             <span className="progress-bar java"></span>
           </p>
           </li>
